...
public struct FocusView: View {
    ...
    public var body: some View {
        GeometryReader { containerGeo in
            ...
            // Scale factors to fit the panel bounds to screen
            ...
            // Choose standard aspect fit scale, capping at 4.5x
            let targetScale = min(4.5, max(1.0, min(targetScaleX, targetScaleY)))
            
            // Center offsets relative to image center
            ...
            .frame(width: containerSize.width, height: containerSize.height)
            .clipped() // Crop bounds outside the viewport frame
